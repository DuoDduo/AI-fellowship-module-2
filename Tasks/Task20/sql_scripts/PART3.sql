...
-- WHERE type_of_membership = 'premium' and date_of_membership > '2021-12-31'
...
-- SELECT  members.member_id, members.member_name, COUNT(borrowhistory.book_id) AS borrow_count
-- FROM 
-- Members
-- LEFT JOIN
...
WHERE 
    ...
    AND borrowhistory.borrow_date < '2023/12/01'
ORDER BY 
